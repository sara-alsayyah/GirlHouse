...
from .views import ProductListAPIView, ProductDetailAPIView, CategoryListAPIView, AddToWishlistAPIView, WishlistAPIView, RemoveFromWishlistAPIView, ProductReviewsAPIView, AddReviewAPIView
